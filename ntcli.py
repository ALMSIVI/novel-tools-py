import argparse
import os
from toolkit import analyze, generate_list, create, add, convert
...
if __name__ == '__main__':
    ...
    analyze_parser.set_defaults(func=lambda a: analyze(a.filename, a.out_dir))
    ...
    generate_list_parser.set_defaults(func=lambda a: generate_list(a.in_dir, a.out_dir))
    ...
    create_parser.set_defaults(func=lambda a: create(None, args.filename, args.out_dir) if os.path.isdir(a.filename)
                               else create(args.filename, os.path.dirname(args.filename), args.out_dir))
