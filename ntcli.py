...
if __name__ == '__main__':
    ...
    create_parser.set_defaults(func=lambda a: create(None, args.filename, args.out_dir, a.config)
                               if os.path.isdir(a.filename)
                               else create(args.filename, os.path.dirname(args.filename), args.out_dir, a.config))
