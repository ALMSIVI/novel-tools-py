...
def create(filename: Optional[str], in_dir: str, out_dir: Optional[str], config: str):
    """
    ...
    objects = generate_objects(config, 'config/create_config.json', in_dir, additional_args)
